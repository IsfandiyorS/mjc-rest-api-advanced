...
public final class OrderModel {
    ...
    public static final OrderDto ORDER_DTO = new OrderDto(1L, BigDecimal.valueOf(10.1), 1L,  UPDATED_USER_DTO, GIFT_CERTIFICATE_DTO, LocalDateTime.now().toString());
    ...
    public static final OrderDto UPDATED_ORDER_DTO = new OrderDto(1L, BigDecimal.valueOf(20.2), 2L,  UPDATED_USER_DTO, GIFT_CERTIFICATE_DTO, LocalDateTime.now().toString());
